        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.positiveIntValue = long_1.default.fromString(reader.uint64().toString(), true);
                    continue;
                }
                case 5: {
                    if (tag !== 40) {
                    ...
                    message.negativeIntValue = long_1.default.fromString(reader.int64().toString());
                    continue;
                }
                case 6: {
                    if (tag !== 49) {
