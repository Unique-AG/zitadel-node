...
exports.InTargetIDsFilter = exports.TargetNameFilter = exports.TargetSearchFilter = exports.TargetFilter = exports.ExecutionTypeFilter = exports.InConditionsFilter = exports.ExecutionSearchFilter = exports.ExecutionFieldName = exports.ExecutionType = exports.TargetFieldName = exports.protobufPackage = void 0;
...
})(TargetFieldName || (exports.TargetFieldName = TargetFieldName = {}));
...
})(ExecutionFieldName || (exports.ExecutionFieldName = ExecutionFieldName = {}));
...
exports.ExecutionSearchFilter = {
    ...
    create(base) {
        return exports.ExecutionSearchFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseExecutionSearchFilter();
...
exports.InConditionsFilter = {
    ...
    create(base) {
        return exports.InConditionsFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseInConditionsFilter();
        message.conditions = object.conditions?.map((e) => execution_js_1.Condition.fromPartial(e)) || [];
        return message;
    },
};
...
exports.ExecutionTypeFilter = {
    ...
    create(base) {
        return exports.ExecutionTypeFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseExecutionTypeFilter();
...
exports.TargetFilter = {
    ...
    create(base) {
        return exports.TargetFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTargetFilter();
...
exports.TargetSearchFilter = {
    ...
    create(base) {
        return exports.TargetSearchFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTargetSearchFilter();
...
exports.TargetNameFilter = {
    ...
    create(base) {
        return exports.TargetNameFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTargetNameFilter();
...
exports.InTargetIDsFilter = {
    ...
    create(base) {
        return exports.InTargetIDsFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseInTargetIDsFilter();
