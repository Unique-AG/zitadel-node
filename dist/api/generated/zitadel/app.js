...
exports.LoginV2 = exports.LoginV1 = exports.LoginVersion = exports.APIConfig = exports.SAMLConfig = exports.OIDCConfig = exports.AppNameQuery = exports.AppQuery = exports.App = exports.APIAuthMethodType = exports.OIDCTokenType = exports.OIDCVersion = exports.OIDCAuthMethodType = exports.OIDCAppType = exports.OIDCGrantType = exports.OIDCResponseType = exports.AppState = exports.protobufPackage = void 0;
...
exports.OIDCConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.loginVersion !== undefined) {
            exports.LoginVersion.encode(message.loginVersion, writer.uint32(178).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 22: {
                    ...
                    message.loginVersion = exports.LoginVersion.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            loginVersion: isSet(object.loginVersion) ? exports.LoginVersion.fromJSON(object.loginVersion) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.loginVersion !== undefined) {
            obj.loginVersion = exports.LoginVersion.toJSON(message.loginVersion);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.complianceProblems = object.complianceProblems?.map((e) => message_js_1.LocalizedMessage.fromPartial(e)) || [];
        ...
        message.loginVersion = (object.loginVersion !== undefined && object.loginVersion !== null)
            ? exports.LoginVersion.fromPartial(object.loginVersion)
            : undefined;
        return message;
    },
};
...
exports.SAMLConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.loginVersion !== undefined) {
            exports.LoginVersion.encode(message.loginVersion, writer.uint32(26).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
exports.LoginVersion = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.loginV1 !== undefined) {
            exports.LoginV1.encode(message.loginV1, writer.uint32(10).fork()).join();
        }
        if (message.loginV2 !== undefined) {
            exports.LoginV2.encode(message.loginV2, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.loginV1 = exports.LoginV1.decode(reader, reader.uint32());
                    continue;
                }
                case 2: {
                    if (tag !== 18) {
                    ...
                    message.loginV2 = exports.LoginV2.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            loginV1: isSet(object.loginV1) ? exports.LoginV1.fromJSON(object.loginV1) : undefined,
            loginV2: isSet(object.loginV2) ? exports.LoginV2.fromJSON(object.loginV2) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.loginV1 !== undefined) {
            obj.loginV1 = exports.LoginV1.toJSON(message.loginV1);
        }
        if (message.loginV2 !== undefined) {
            obj.loginV2 = exports.LoginV2.toJSON(message.loginV2);
        }
        return obj;
    },
    create(base) {
        return exports.LoginVersion.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseLoginVersion();
        message.loginV1 = (object.loginV1 !== undefined && object.loginV1 !== null)
            ? exports.LoginV1.fromPartial(object.loginV1)
            : undefined;
        message.loginV2 = (object.loginV2 !== undefined && object.loginV2 !== null)
            ? exports.LoginV2.fromPartial(object.loginV2)
            : undefined;
        return message;
    },
};
...
exports.LoginV1 = {
    ...
    create(base) {
        return exports.LoginV1.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseLoginV1();
        return message;
...
exports.LoginV2 = {
    ...
    create(base) {
        return exports.LoginV2.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseLoginV2();
