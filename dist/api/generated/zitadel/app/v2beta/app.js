...
exports.ApplicationKey = exports.ApplicationNameQuery = exports.ApplicationSearchFilter = exports.Application = exports.ApplicationKeysSorting = exports.AppSorting = exports.AppState = exports.protobufPackage = void 0;
exports.appStateFromJSON = appStateFromJSON;
exports.appStateToJSON = appStateToJSON;
exports.appSortingFromJSON = appSortingFromJSON;
exports.appSortingToJSON = appSortingToJSON;
exports.applicationKeysSortingFromJSON = applicationKeysSortingFromJSON;
exports.applicationKeysSortingToJSON = applicationKeysSortingToJSON;
/* eslint-disable */
...
})(AppSorting || (exports.AppSorting = AppSorting = {}));
function appSortingFromJSON(object) {
    switch (object) {
        case 0:
        case "APP_SORT_BY_ID":
...
function appSortingToJSON(object) {
    switch (object) {
...
})(ApplicationKeysSorting || (exports.ApplicationKeysSorting = ApplicationKeysSorting = {}));
function applicationKeysSortingFromJSON(object) {
    switch (object) {
        case 0:
...
function applicationKeysSortingToJSON(object) {
    switch (object) {
...
exports.Application = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.oidcConfig !== undefined) {
            oidc_js_1.OIDCConfig.encode(message.oidcConfig, writer.uint32(50).fork()).join();
        }
        if (message.apiConfig !== undefined) {
            api_js_1.APIConfig.encode(message.apiConfig, writer.uint32(58).fork()).join();
        }
        if (message.samlConfig !== undefined) {
            saml_js_1.SAMLConfig.encode(message.samlConfig, writer.uint32(66).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6: {
                    ...
                    message.oidcConfig = oidc_js_1.OIDCConfig.decode(reader, reader.uint32());
                    continue;
                }
                case 7: {
                    if (tag !== 58) {
                    ...
                    message.apiConfig = api_js_1.APIConfig.decode(reader, reader.uint32());
                    continue;
                }
                case 8: {
                    if (tag !== 66) {
                    ...
                    message.samlConfig = saml_js_1.SAMLConfig.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            oidcConfig: isSet(object.oidcConfig) ? oidc_js_1.OIDCConfig.fromJSON(object.oidcConfig) : undefined,
            apiConfig: isSet(object.apiConfig) ? api_js_1.APIConfig.fromJSON(object.apiConfig) : undefined,
            samlConfig: isSet(object.samlConfig) ? saml_js_1.SAMLConfig.fromJSON(object.samlConfig) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.oidcConfig !== undefined) {
            obj.oidcConfig = oidc_js_1.OIDCConfig.toJSON(message.oidcConfig);
        }
        if (message.apiConfig !== undefined) {
            obj.apiConfig = api_js_1.APIConfig.toJSON(message.apiConfig);
        }
        if (message.samlConfig !== undefined) {
            obj.samlConfig = saml_js_1.SAMLConfig.toJSON(message.samlConfig);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.oidcConfig = (object.oidcConfig !== undefined && object.oidcConfig !== null)
            ? oidc_js_1.OIDCConfig.fromPartial(object.oidcConfig)
            : undefined;
        message.apiConfig = (object.apiConfig !== undefined && object.apiConfig !== null)
            ? api_js_1.APIConfig.fromPartial(object.apiConfig)
            : undefined;
        message.samlConfig = (object.samlConfig !== undefined && object.samlConfig !== null)
            ? saml_js_1.SAMLConfig.fromPartial(object.samlConfig)
            : undefined;
        return message;
    },
};
...
exports.ApplicationSearchFilter = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.nameFilter !== undefined) {
            exports.ApplicationNameQuery.encode(message.nameFilter, writer.uint32(10).fork()).join();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.nameFilter = exports.ApplicationNameQuery.decode(reader, reader.uint32());
                    continue;
                }
                case 2: {
                    if (tag !== 16) {
    ...
    fromJSON(object) {
        return {
            nameFilter: isSet(object.nameFilter) ? exports.ApplicationNameQuery.fromJSON(object.nameFilter) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.nameFilter !== undefined) {
            obj.nameFilter = exports.ApplicationNameQuery.toJSON(message.nameFilter);
        }
        if (message.stateFilter !== undefined) {
    ...
    create(base) {
        return exports.ApplicationSearchFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseApplicationSearchFilter();
        message.nameFilter = (object.nameFilter !== undefined && object.nameFilter !== null)
            ? exports.ApplicationNameQuery.fromPartial(object.nameFilter)
            : undefined;
...
exports.ApplicationNameQuery = {
    ...
    create(base) {
        return exports.ApplicationNameQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseApplicationNameQuery();
        message.name = object.name ?? "";
...
exports.ApplicationKey = {
    ...
    create(base) {
        return exports.ApplicationKey.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseApplicationKey();
        message.id = object.id ?? "";
