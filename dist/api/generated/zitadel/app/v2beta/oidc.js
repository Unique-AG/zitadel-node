...
exports.OIDCConfig = exports.OIDCLocalizedMessage = exports.OIDCTokenType = exports.OIDCVersion = exports.OIDCAuthMethodType = exports.OIDCAppType = exports.OIDCGrantType = exports.OIDCResponseType = exports.protobufPackage = void 0;
...
exports.OIDCLocalizedMessage = {
    ...
    create(base) {
        return exports.OIDCLocalizedMessage.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOIDCLocalizedMessage();
...
exports.OIDCConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.complianceProblems) {
            exports.OIDCLocalizedMessage.encode(v, writer.uint32(82).fork()).join();
        }
        ...
        if (message.clockSkew !== undefined) {
            duration_js_1.Duration.encode(message.clockSkew, writer.uint32(130).fork()).join();
        }
        ...
        if (message.loginVersion !== undefined) {
            login_js_1.LoginVersion.encode(message.loginVersion, writer.uint32(170).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10: {
                    ...
                    message.complianceProblems.push(exports.OIDCLocalizedMessage.decode(reader, reader.uint32()));
                    continue;
                }
                case 11: {
                    if (tag !== 88) {
    ...
    fromJSON(object) {
        return {
            ...
            complianceProblems: globalThis.Array.isArray(object?.complianceProblems)
                ? object.complianceProblems.map((e) => exports.OIDCLocalizedMessage.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.complianceProblems?.length) {
            obj.complianceProblems = message.complianceProblems.map((e) => exports.OIDCLocalizedMessage.toJSON(e));
        }
        if (message.devMode !== false) {
    ...
    fromPartial(object) {
        ...
        message.complianceProblems = object.complianceProblems?.map((e) => exports.OIDCLocalizedMessage.fromPartial(e)) || [];
