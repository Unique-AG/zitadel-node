...
exports.LoginV2 = exports.LoginV2FeatureFlag = exports.ImprovedPerformanceFeatureFlag = exports.FeatureFlag = exports.ImprovedPerformance = exports.Source = exports.protobufPackage = void 0;
...
exports.FeatureFlag = {
    ...
    create(base) {
        return exports.FeatureFlag.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseFeatureFlag();
...
function createBaseLoginV2FeatureFlag() {
    return { required: false, baseUri: undefined, source: 0 };
}
exports.LoginV2FeatureFlag = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.LoginV2FeatureFlag.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseLoginV2FeatureFlag();
...
function createBaseLoginV2() {
    return { required: false, baseUri: undefined };
}
exports.LoginV2 = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.required !== false) {
