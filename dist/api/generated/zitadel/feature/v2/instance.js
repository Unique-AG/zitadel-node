...
export const SetInstanceFeaturesRequest = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.loginV2 !== undefined) {
            LoginV2.encode(message.loginV2, writer.uint32(106).fork()).join();
        }
...
export const GetInstanceFeaturesResponse = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.loginV2 !== undefined) {
            LoginV2FeatureFlag.encode(message.loginV2, writer.uint32(114).fork()).join();
        }
        if (message.permissionCheckV2 !== undefined) {
            FeatureFlag.encode(message.permissionCheckV2, writer.uint32(122).fork()).join();
        }
        if (message.consoleUseV2UserApi !== undefined) {
            FeatureFlag.encode(message.consoleUseV2UserApi, writer.uint32(130).fork()).join();
        }
        if (message.enableRelationalTables !== undefined) {
            FeatureFlag.encode(message.enableRelationalTables, writer.uint32(138).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 16: {
                    ...
                    message.consoleUseV2UserApi = FeatureFlag.decode(reader, reader.uint32());
                    continue;
                }
                case 17: {
                    if (tag !== 138) {
    ...
    fromJSON(object) {
        return {
            ...
            consoleUseV2UserApi: isSet(object.consoleUseV2UserApi)
                ? FeatureFlag.fromJSON(object.consoleUseV2UserApi)
                : undefined,
            enableRelationalTables: isSet(object.enableRelationalTables)
    ...
    toJSON(message) {
        ...
        if (message.consoleUseV2UserApi !== undefined) {
            obj.consoleUseV2UserApi = FeatureFlag.toJSON(message.consoleUseV2UserApi);
        }
        if (message.enableRelationalTables !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.consoleUseV2UserApi = (object.consoleUseV2UserApi !== undefined && object.consoleUseV2UserApi !== null)
            ? FeatureFlag.fromPartial(object.consoleUseV2UserApi)
            : undefined;
