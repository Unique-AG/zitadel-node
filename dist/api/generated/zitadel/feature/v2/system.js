...
exports.GetSystemFeaturesResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.disableUserTokenEvent !== undefined) {
            feature_js_1.FeatureFlag.encode(message.disableUserTokenEvent, writer.uint32(82).fork()).join();
        }
        if (message.enableBackChannelLogout !== undefined) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10: {
                    ...
                    message.disableUserTokenEvent = feature_js_1.FeatureFlag.decode(reader, reader.uint32());
                    continue;
                }
                case 11: {
                    if (tag !== 90) {
    ...
    fromJSON(object) {
        return {
            ...
            oidcSingleV1SessionTermination: isSet(object.oidcSingleV1SessionTermination)
                ...
                : undefined,
            disableUserTokenEvent: isSet(object.disableUserTokenEvent)
                ? feature_js_1.FeatureFlag.fromJSON(object.disableUserTokenEvent)
                : undefined,
            enableBackChannelLogout: isSet(object.enableBackChannelLogout)
    ...
    toJSON(message) {
        ...
        if (message.disableUserTokenEvent !== undefined) {
            obj.disableUserTokenEvent = feature_js_1.FeatureFlag.toJSON(message.disableUserTokenEvent);
        }
        if (message.enableBackChannelLogout !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.disableUserTokenEvent =
            (object.disableUserTokenEvent !== undefined && object.disableUserTokenEvent !== null)
                ? feature_js_1.FeatureFlag.fromPartial(object.disableUserTokenEvent)
                : undefined;
