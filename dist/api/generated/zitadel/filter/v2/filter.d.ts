...
export declare const protobufPackage = "zitadel.filter.v2";
...
export declare enum ByteFilterMethod {
    BYTE_FILTER_METHOD_EQUALS = 0,
    BYTE_FILTER_METHOD_NOT_EQUALS = 1,
    UNRECOGNIZED = -1
}
export declare function byteFilterMethodFromJSON(object: any): ByteFilterMethod;
export declare function byteFilterMethodToJSON(object: ByteFilterMethod): string;
