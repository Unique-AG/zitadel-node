...
export function sAMLSignatureAlgorithmFromJSON(object) {
    switch (object) {
        case 0:
...
export function sAMLSignatureAlgorithmToJSON(object) {
    switch (object) {
...
export const OAuthConfig = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.usePkce !== false) {
            writer.uint32(56).bool(message.usePkce);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            usePkce: isSet(object.usePkce) ? globalThis.Boolean(object.usePkce) : false,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.usePkce = object.usePkce ?? false;
        return message;
    },
};
function createBaseGenericOIDCConfig() {
    return { issuer: "", clientId: "", scopes: [], isIdTokenMapping: false, usePkce: false };
}
export const GenericOIDCConfig = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.usePkce !== false) {
            writer.uint32(40).bool(message.usePkce);
        }
        return writer;
    },
    decode(input, length) {
