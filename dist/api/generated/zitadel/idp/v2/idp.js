...
exports.AppleConfig = exports.AzureADTenant = exports.LDAPAttributes = exports.Options = exports.AzureADConfig = exports.SAMLConfig = exports.LDAPConfig = exports.GitLabSelfHostedConfig = exports.GitLabConfig = exports.GoogleConfig = exports.GitHubEnterpriseServerConfig = exports.GitHubConfig = exports.GenericOIDCConfig = exports.OAuthConfig = exports.JWTConfig = exports.IDPConfig = exports.IDP = exports.AzureADTenantType = exports.AutoLinkingOption = exports.SAMLNameIDFormat = exports.SAMLSignatureAlgorithm = exports.SAMLBinding = exports.IDPType = exports.IDPState = exports.protobufPackage = void 0;
...
exports.sAMLSignatureAlgorithmFromJSON = sAMLSignatureAlgorithmFromJSON;
exports.sAMLSignatureAlgorithmToJSON = sAMLSignatureAlgorithmToJSON;
...
(function (SAMLSignatureAlgorithm) {
    SAMLSignatureAlgorithm[SAMLSignatureAlgorithm["SAML_SIGNATURE_UNSPECIFIED"] = 0] = "SAML_SIGNATURE_UNSPECIFIED";
    SAMLSignatureAlgorithm[SAMLSignatureAlgorithm["SAML_SIGNATURE_RSA_SHA1"] = 1] = "SAML_SIGNATURE_RSA_SHA1";
    SAMLSignatureAlgorithm[SAMLSignatureAlgorithm["SAML_SIGNATURE_RSA_SHA256"] = 2] = "SAML_SIGNATURE_RSA_SHA256";
    SAMLSignatureAlgorithm[SAMLSignatureAlgorithm["SAML_SIGNATURE_RSA_SHA512"] = 3] = "SAML_SIGNATURE_RSA_SHA512";
    SAMLSignatureAlgorithm[SAMLSignatureAlgorithm["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(SAMLSignatureAlgorithm || (exports.SAMLSignatureAlgorithm = SAMLSignatureAlgorithm = {}));
function sAMLSignatureAlgorithmFromJSON(object) {
    switch (object) {
        case 0:
        case "SAML_SIGNATURE_UNSPECIFIED":
            return SAMLSignatureAlgorithm.SAML_SIGNATURE_UNSPECIFIED;
        case 1:
        case "SAML_SIGNATURE_RSA_SHA1":
            return SAMLSignatureAlgorithm.SAML_SIGNATURE_RSA_SHA1;
        case 2:
        case "SAML_SIGNATURE_RSA_SHA256":
            return SAMLSignatureAlgorithm.SAML_SIGNATURE_RSA_SHA256;
        case 3:
        case "SAML_SIGNATURE_RSA_SHA512":
            return SAMLSignatureAlgorithm.SAML_SIGNATURE_RSA_SHA512;
        case -1:
        case "UNRECOGNIZED":
        default:
            return SAMLSignatureAlgorithm.UNRECOGNIZED;
    }
}
function sAMLSignatureAlgorithmToJSON(object) {
    switch (object) {
        case SAMLSignatureAlgorithm.SAML_SIGNATURE_UNSPECIFIED:
            return "SAML_SIGNATURE_UNSPECIFIED";
        case SAMLSignatureAlgorithm.SAML_SIGNATURE_RSA_SHA1:
            return "SAML_SIGNATURE_RSA_SHA1";
        case SAMLSignatureAlgorithm.SAML_SIGNATURE_RSA_SHA256:
            return "SAML_SIGNATURE_RSA_SHA256";
        case SAMLSignatureAlgorithm.SAML_SIGNATURE_RSA_SHA512:
            return "SAML_SIGNATURE_RSA_SHA512";
        case SAMLSignatureAlgorithm.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
...
exports.LDAPConfig = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10: {
                    ...
                    message.rootCa = Buffer.from(reader.bytes());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            rootCa: isSet(object.rootCa) ? Buffer.from(bytesFromBase64(object.rootCa)) : Buffer.alloc(0),
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.rootCa.length !== 0) {
            obj.rootCa = base64FromBytes(message.rootCa);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.attributes = (object.attributes !== undefined && object.attributes !== null)
            ...
            : undefined;
        message.rootCa = object.rootCa ?? Buffer.alloc(0);
        return message;
    },
};
function createBaseSAMLConfig() {
    return {
        ...
        federatedLogoutEnabled: undefined,
...
exports.SAMLConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.federatedLogoutEnabled !== undefined) {
            writer.uint32(48).bool(message.federatedLogoutEnabled);
        }
        if (message.signatureAlgorithm !== 0) {
            writer.uint32(56).int32(message.signatureAlgorithm);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6: {
                    ...
                    message.federatedLogoutEnabled = reader.bool();
                    continue;
                }
                case 7: {
                    if (tag !== 56) {
    ...
    fromJSON(object) {
        return {
            ...
            transientMappingAttributeName: isSet(object.transientMappingAttributeName)
                ...
                : undefined,
            federatedLogoutEnabled: isSet(object.federatedLogoutEnabled)
                ? globalThis.Boolean(object.federatedLogoutEnabled)
                : undefined,
            signatureAlgorithm: isSet(object.signatureAlgorithm)
                ? sAMLSignatureAlgorithmFromJSON(object.signatureAlgorithm)
                : 0,
        };
    },
    toJSON(message) {
        ...
        if (message.federatedLogoutEnabled !== undefined) {
            obj.federatedLogoutEnabled = message.federatedLogoutEnabled;
        }
        if (message.signatureAlgorithm !== 0) {
            obj.signatureAlgorithm = sAMLSignatureAlgorithmToJSON(message.signatureAlgorithm);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.federatedLogoutEnabled = object.federatedLogoutEnabled ?? undefined;
...
exports.LDAPAttributes = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.rootCa !== "") {
            writer.uint32(114).string(message.rootCa);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            rootCa: isSet(object.rootCa) ? globalThis.String(object.rootCa) : "",
        };
    },
    toJSON(message) {
        const obj = {};
