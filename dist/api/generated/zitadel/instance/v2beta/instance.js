...
export function domainFieldNameFromJSON(object) {
    switch (object) {
        case 0:
...
export function domainFieldNameToJSON(object) {
    switch (object) {
...
export var TrustedDomainFieldName;
(function (TrustedDomainFieldName) {
    TrustedDomainFieldName[TrustedDomainFieldName["TRUSTED_DOMAIN_FIELD_NAME_UNSPECIFIED"] = 0] = "TRUSTED_DOMAIN_FIELD_NAME_UNSPECIFIED";
    TrustedDomainFieldName[TrustedDomainFieldName["TRUSTED_DOMAIN_FIELD_NAME_DOMAIN"] = 1] = "TRUSTED_DOMAIN_FIELD_NAME_DOMAIN";
    TrustedDomainFieldName[TrustedDomainFieldName["TRUSTED_DOMAIN_FIELD_NAME_CREATION_DATE"] = 2] = "TRUSTED_DOMAIN_FIELD_NAME_CREATION_DATE";
    TrustedDomainFieldName[TrustedDomainFieldName["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(TrustedDomainFieldName || (TrustedDomainFieldName = {}));
export function trustedDomainFieldNameFromJSON(object) {
    switch (object) {
        case 0:
        case "TRUSTED_DOMAIN_FIELD_NAME_UNSPECIFIED":
            return TrustedDomainFieldName.TRUSTED_DOMAIN_FIELD_NAME_UNSPECIFIED;
        case 1:
        case "TRUSTED_DOMAIN_FIELD_NAME_DOMAIN":
            return TrustedDomainFieldName.TRUSTED_DOMAIN_FIELD_NAME_DOMAIN;
        case 2:
        case "TRUSTED_DOMAIN_FIELD_NAME_CREATION_DATE":
            return TrustedDomainFieldName.TRUSTED_DOMAIN_FIELD_NAME_CREATION_DATE;
        case -1:
        case "UNRECOGNIZED":
        default:
            return TrustedDomainFieldName.UNRECOGNIZED;
    }
}
export function trustedDomainFieldNameToJSON(object) {
    switch (object) {
        case TrustedDomainFieldName.TRUSTED_DOMAIN_FIELD_NAME_UNSPECIFIED:
            return "TRUSTED_DOMAIN_FIELD_NAME_UNSPECIFIED";
        case TrustedDomainFieldName.TRUSTED_DOMAIN_FIELD_NAME_DOMAIN:
            return "TRUSTED_DOMAIN_FIELD_NAME_DOMAIN";
        case TrustedDomainFieldName.TRUSTED_DOMAIN_FIELD_NAME_CREATION_DATE:
            return "TRUSTED_DOMAIN_FIELD_NAME_CREATION_DATE";
        case TrustedDomainFieldName.UNRECOGNIZED:
        default:
            return "UNRECOGNIZED";
    }
}
function createBaseInstance() {
    return { id: "", changeDate: undefined, creationDate: undefined, state: 0, name: "", version: "", domains: [] };
}
export const Instance = {
    encode(message, writer = new BinaryWriter()) {
        ...
        for (const v of message.domains) {
            Domain.encode(v, writer.uint32(58).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
function createBaseDomain() {
    return { instanceId: "", creationDate: undefined, domain: "", primary: false, generated: false };
}
export const Domain = {
    encode(message, writer = new BinaryWriter()) {
...
export const Query = {
    encode(message, writer = new BinaryWriter()) {
        if (message.idQuery !== undefined) {
            IdsQuery.encode(message.idQuery, writer.uint32(10).fork()).join();
        }
        if (message.domainQuery !== undefined) {
            DomainsQuery.encode(message.domainQuery, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        const obj = {};
        if (message.idQuery !== undefined) {
            obj.idQuery = IdsQuery.toJSON(message.idQuery);
        }
        if (message.domainQuery !== undefined) {
            obj.domainQuery = DomainsQuery.toJSON(message.domainQuery);
        }
        return obj;
    },
    create(base) {
...
export const DomainSearchQuery = {
    encode(message, writer = new BinaryWriter()) {
        if (message.domainQuery !== undefined) {
            DomainQuery.encode(message.domainQuery, writer.uint32(10).fork()).join();
        }
        if (message.generatedQuery !== undefined) {
            DomainGeneratedQuery.encode(message.generatedQuery, writer.uint32(18).fork()).join();
        }
        if (message.primaryQuery !== undefined) {
            DomainPrimaryQuery.encode(message.primaryQuery, writer.uint32(26).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        if (message.generatedQuery !== undefined) {
            obj.generatedQuery = DomainGeneratedQuery.toJSON(message.generatedQuery);
        }
        if (message.primaryQuery !== undefined) {
            obj.primaryQuery = DomainPrimaryQuery.toJSON(message.primaryQuery);
        }
        return obj;
    },
    create(base) {
...
function createBaseTrustedDomain() {
    return { instanceId: "", creationDate: undefined, domain: "" };
}
export const TrustedDomain = {
    encode(message, writer = new BinaryWriter()) {
        if (message.instanceId !== "") {
            writer.uint32(10).string(message.instanceId);
        }
    ...
    create(base) {
        return TrustedDomain.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrustedDomain();
        message.instanceId = object.instanceId ?? "";
...
export const TrustedDomainSearchQuery = {
    encode(message, writer = new BinaryWriter()) {
        if (message.domainQuery !== undefined) {
            DomainQuery.encode(message.domainQuery, writer.uint32(10).fork()).join();
        }
    ...
    fromJSON(object) {
        return { domainQuery: isSet(object.domainQuery) ? DomainQuery.fromJSON(object.domainQuery) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.domainQuery !== undefined) {
    ...
    create(base) {
        return TrustedDomainSearchQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrustedDomainSearchQuery();
        message.domainQuery = (object.domainQuery !== undefined && object.domainQuery !== null)
