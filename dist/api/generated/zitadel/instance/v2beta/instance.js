...
exports.TrustedDomainSearchQuery = exports.TrustedDomain = exports.DomainPrimaryQuery = exports.DomainGeneratedQuery = exports.DomainQuery = exports.DomainSearchQuery = exports.DomainsQuery = exports.IdsQuery = exports.Query = exports.Domain = exports.Instance = exports.TrustedDomainFieldName = exports.DomainFieldName = exports.FieldName = exports.State = exports.protobufPackage = void 0;
...
exports.trustedDomainFieldNameFromJSON = trustedDomainFieldNameFromJSON;
exports.trustedDomainFieldNameToJSON = trustedDomainFieldNameToJSON;
/* eslint-disable */
...
})(TrustedDomainFieldName || (exports.TrustedDomainFieldName = TrustedDomainFieldName = {}));
function trustedDomainFieldNameFromJSON(object) {
    switch (object) {
        case 0:
...
function trustedDomainFieldNameToJSON(object) {
    switch (object) {
...
exports.Instance = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.domains) {
            exports.Domain.encode(v, writer.uint32(58).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            domains: globalThis.Array.isArray(object?.domains) ? object.domains.map((e) => exports.Domain.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.TrustedDomain = {
    ...
    create(base) {
        return exports.TrustedDomain.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrustedDomain();
        message.instanceId = object.instanceId ?? "";
...
exports.TrustedDomainSearchQuery = {
    ...
    create(base) {
        return exports.TrustedDomainSearchQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrustedDomainSearchQuery();
        message.domainQuery = (object.domainQuery !== undefined && object.domainQuery !== null)
