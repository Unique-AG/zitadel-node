...
exports.LocalizedMessage = exports.CredentialsCheckError = exports.ErrorDetail = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseCredentialsCheckError() {
    return { id: "", message: "", failedAttempts: 0 };
}
exports.CredentialsCheckError = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.id !== "") {
            writer.uint32(10).string(message.id);
        }
        ...
        if (message.failedAttempts !== 0) {
            writer.uint32(24).int32(message.failedAttempts);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof wire_1.BinaryReader ? input : new wire_1.BinaryReader(input);
        const end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseCredentialsCheckError();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create(base) {
        return exports.CredentialsCheckError.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCredentialsCheckError();
        message.id = object.id ?? "";
