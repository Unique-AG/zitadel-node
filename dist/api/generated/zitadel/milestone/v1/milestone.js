...
export function milestoneTypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function milestoneTypeToJSON(object) {
    switch (object) {
...
})(MilestoneFieldName || (MilestoneFieldName = {}));
export function milestoneFieldNameFromJSON(object) {
    switch (object) {
        case 0:
...
export function milestoneFieldNameToJSON(object) {
    switch (object) {
