...
exports.DeviceAuthorizationRequest = exports.AuthorizationError = exports.AuthRequest = exports.ErrorReason = exports.Prompt = exports.protobufPackage = void 0;
...
exports.AuthRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.maxAge !== undefined) {
            duration_js_1.Duration.encode(message.maxAge, writer.uint32(74).fork()).join();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9: {
                    ...
                    message.maxAge = duration_js_1.Duration.decode(reader, reader.uint32());
                    continue;
                }
                case 10: {
                    if (tag !== 82) {
    ...
    fromJSON(object) {
        return {
            ...
            maxAge: isSet(object.maxAge) ? duration_js_1.Duration.fromJSON(object.maxAge) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.maxAge !== undefined) {
            obj.maxAge = duration_js_1.Duration.toJSON(message.maxAge);
        }
        if (message.hintUserId !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.maxAge = (object.maxAge !== undefined && object.maxAge !== null)
            ? duration_js_1.Duration.fromPartial(object.maxAge)
            : undefined;
...
function createBaseDeviceAuthorizationRequest() {
    return { id: "", clientId: "", scope: [], appName: "", projectName: "" };
}
exports.DeviceAuthorizationRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.id !== "") {
            writer.uint32(10).string(message.id);
        }
    ...
    decode(input, length) {
        const reader = input instanceof wire_1.BinaryReader ? input : new wire_1.BinaryReader(input);
        const end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseDeviceAuthorizationRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create(base) {
        return exports.DeviceAuthorizationRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeviceAuthorizationRequest();
        message.id = object.id ?? "";
