...
import { organizationFieldNameFromJSON, organizationFieldNameToJSON, SearchQuery, } from "./query.js";
...
export const ListOrganizationsResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            sortingColumn: isSet(object.sortingColumn) ? organizationFieldNameFromJSON(object.sortingColumn) : 0,
            result: globalThis.Array.isArray(object?.result) ? object.result.map((e) => Organization.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
