...
function createBaseAddOrganizationRequest() {
    return { name: "", admins: [], orgId: undefined };
}
...
exports.ListOrganizationsRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            sortingColumn: isSet(object.sortingColumn) ? (0, query_js_1.organizationFieldNameFromJSON)(object.sortingColumn) : 0,
...
exports.ListOrganizationsResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            sortingColumn: isSet(object.sortingColumn) ? (0, query_js_1.organizationFieldNameFromJSON)(object.sortingColumn) : 0,
            result: globalThis.Array.isArray(object?.result) ? object.result.map((e) => org_js_1.Organization.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.details = (object.details !== undefined && object.details !== null)
            ...
            : undefined;
        message.sortingColumn = object.sortingColumn ?? 0;
        message.result = object.result?.map((e) => org_js_1.Organization.fromPartial(e)) || [];
        return message;
    },
};
