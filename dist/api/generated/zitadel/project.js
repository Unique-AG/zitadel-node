...
export const GrantedProject = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.details !== undefined) {
            ObjectDetails.encode(message.details, writer.uint32(82).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const ProjectQuery = {
    encode(message, writer = new BinaryWriter()) {
        if (message.nameQuery !== undefined) {
            ProjectNameQuery.encode(message.nameQuery, writer.uint32(10).fork()).join();
        }
        if (message.projectResourceOwnerQuery !== undefined) {
            ProjectResourceOwnerQuery.encode(message.projectResourceOwnerQuery, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        const obj = {};
        if (message.nameQuery !== undefined) {
            obj.nameQuery = ProjectNameQuery.toJSON(message.nameQuery);
        }
        if (message.projectResourceOwnerQuery !== undefined) {
            obj.projectResourceOwnerQuery = ProjectResourceOwnerQuery.toJSON(message.projectResourceOwnerQuery);
        }
        return obj;
    },
    create(base) {
...
export const RoleQuery = {
    encode(message, writer = new BinaryWriter()) {
        if (message.keyQuery !== undefined) {
            RoleKeyQuery.encode(message.keyQuery, writer.uint32(10).fork()).join();
        }
        if (message.displayNameQuery !== undefined) {
            RoleDisplayNameQuery.encode(message.displayNameQuery, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        const obj = {};
        if (message.keyQuery !== undefined) {
            obj.keyQuery = RoleKeyQuery.toJSON(message.keyQuery);
        }
        if (message.displayNameQuery !== undefined) {
            obj.displayNameQuery = RoleDisplayNameQuery.toJSON(message.displayNameQuery);
        }
        return obj;
    },
    create(base) {
...
export const ProjectGrantQuery = {
    encode(message, writer = new BinaryWriter()) {
        if (message.projectNameQuery !== undefined) {
            GrantProjectNameQuery.encode(message.projectNameQuery, writer.uint32(10).fork()).join();
        }
        if (message.roleKeyQuery !== undefined) {
            GrantRoleKeyQuery.encode(message.roleKeyQuery, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        const obj = {};
        if (message.projectNameQuery !== undefined) {
            obj.projectNameQuery = GrantProjectNameQuery.toJSON(message.projectNameQuery);
        }
        if (message.roleKeyQuery !== undefined) {
            obj.roleKeyQuery = GrantRoleKeyQuery.toJSON(message.roleKeyQuery);
        }
        return obj;
    },
    create(base) {
...
export const AllProjectGrantQuery = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.projectIdQuery !== undefined) {
            ProjectIDQuery.encode(message.projectIdQuery, writer.uint32(26).fork()).join();
        }
        if (message.grantedOrgIdQuery !== undefined) {
            GrantedOrgIDQuery.encode(message.grantedOrgIdQuery, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        if (message.projectIdQuery !== undefined) {
            obj.projectIdQuery = ProjectIDQuery.toJSON(message.projectIdQuery);
        }
        if (message.grantedOrgIdQuery !== undefined) {
            obj.grantedOrgIdQuery = GrantedOrgIDQuery.toJSON(message.grantedOrgIdQuery);
        }
        return obj;
    },
    create(base) {
