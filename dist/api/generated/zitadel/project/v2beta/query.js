...
export const ProjectRoleSearchFilter = {
    encode(message, writer = new BinaryWriter()) {
        if (message.roleKeyFilter !== undefined) {
    ...
    fromJSON(object) {
        return {
            ...
            displayNameFilter: isSet(object.displayNameFilter)
                ? ProjectRoleDisplayNameFilter.fromJSON(object.displayNameFilter)
                : undefined,
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.displayNameFilter = (object.displayNameFilter !== undefined && object.displayNameFilter !== null)
            ? ProjectRoleDisplayNameFilter.fromPartial(object.displayNameFilter)
            : undefined;
        return message;
    },
};
...
export const ProjectRoleKeyFilter = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
    ...
    create(base) {
        return ProjectRoleKeyFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseProjectRoleKeyFilter();
        message.key = object.key ?? "";
...
export const ProjectRoleDisplayNameFilter = {
    encode(message, writer = new BinaryWriter()) {
        if (message.displayName !== "") {
    ...
    create(base) {
        return ProjectRoleDisplayNameFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseProjectRoleDisplayNameFilter();
        message.displayName = object.displayName ?? "";
