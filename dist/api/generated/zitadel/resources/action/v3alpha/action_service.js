...
exports.SearchTargetsRequest = {
    ...
    create(base) {
        return exports.SearchTargetsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSearchTargetsRequest();
        message.instance = (object.instance !== undefined && object.instance !== null)
...
exports.SearchTargetsResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            result: globalThis.Array.isArray(object?.result) ? object.result.map((e) => target_js_1.GetTarget.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.SearchTargetsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSearchTargetsResponse();
        message.details = (object.details !== undefined && object.details !== null)
            ...
            : undefined;
        message.result = object.result?.map((e) => target_js_1.GetTarget.fromPartial(e)) || [];
        return message;
    },
};
...
exports.SearchExecutionsRequest = {
    ...
    create(base) {
        return exports.SearchExecutionsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSearchExecutionsRequest();
        message.instance = (object.instance !== undefined && object.instance !== null)
...
exports.SearchExecutionsResponse = {
    ...
    fromJSON(object) {
        return {
            details: isSet(object.details) ? object_js_2.ListDetails.fromJSON(object.details) : undefined,
            result: globalThis.Array.isArray(object?.result) ? object.result.map((e) => execution_js_1.GetExecution.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.SearchExecutionsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSearchExecutionsResponse();
        message.details = (object.details !== undefined && object.details !== null)
            ? object_js_2.ListDetails.fromPartial(object.details)
            : undefined;
        message.result = object.result?.map((e) => execution_js_1.GetExecution.fromPartial(e)) || [];
        return message;
    },
};
