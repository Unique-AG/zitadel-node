...
exports.Execution = {
    ...
    fromPartial(object) {
        const message = createBaseExecution();
        message.targets = object.targets?.map((e) => exports.ExecutionTargetType.fromPartial(e)) || [];
        return message;
    },
};
...
exports.GetExecution = {
    ...
    create(base) {
        return exports.GetExecution.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetExecution();
...
exports.ExecutionTargetType = {
    ...
    create(base) {
        return exports.ExecutionTargetType.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseExecutionTargetType();
