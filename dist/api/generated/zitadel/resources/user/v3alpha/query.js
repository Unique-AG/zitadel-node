...
exports.SchemaTypeFilter = exports.SchemaIDFilter = exports.StateFilter = exports.PhoneFilter = exports.EmailFilter = exports.UsernameFilter = exports.OrganizationIDFilter = exports.UserIDFilter = exports.NotFilter = exports.AndFilter = exports.OrFilter = exports.SearchFilter = exports.FieldName = exports.protobufPackage = void 0;
...
exports.SearchFilter = {
    ...
    create(base) {
        return exports.SearchFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSearchFilter();
...
exports.OrFilter = {
    ...
    fromPartial(object) {
        const message = createBaseOrFilter();
        message.queries = object.queries?.map((e) => exports.SearchFilter.fromPartial(e)) || [];
        return message;
    },
};
...
exports.UserIDFilter = {
    ...
    create(base) {
        return exports.UserIDFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUserIDFilter();
...
exports.OrganizationIDFilter = {
    ...
    create(base) {
        return exports.OrganizationIDFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOrganizationIDFilter();
        message.id = object.id ?? "";
...
exports.UsernameFilter = {
    ...
    create(base) {
        return exports.UsernameFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUsernameFilter();
...
exports.EmailFilter = {
    ...
    create(base) {
        return exports.EmailFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEmailFilter();
...
exports.PhoneFilter = {
    ...
    create(base) {
        return exports.PhoneFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePhoneFilter();
...
exports.StateFilter = {
    ...
    create(base) {
        return exports.StateFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStateFilter();
...
exports.SchemaIDFilter = {
    ...
    create(base) {
        return exports.SchemaIDFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSchemaIDFilter();
        message.id = object.id ?? "";
...
exports.SchemaTypeFilter = {
    ...
    create(base) {
        return exports.SchemaTypeFilter.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSchemaTypeFilter();
