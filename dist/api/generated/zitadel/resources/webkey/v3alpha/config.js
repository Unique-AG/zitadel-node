...
exports.WebKeyED25519Config = exports.WebKeyECDSAConfig = exports.WebKeyRSAConfig = exports.WebKeyECDSAConfig_ECDSACurve = exports.WebKeyRSAConfig_RSAHasher = exports.WebKeyRSAConfig_RSABits = exports.protobufPackage = void 0;
exports.webKeyRSAConfig_RSABitsFromJSON = webKeyRSAConfig_RSABitsFromJSON;
exports.webKeyRSAConfig_RSABitsToJSON = webKeyRSAConfig_RSABitsToJSON;
exports.webKeyRSAConfig_RSAHasherFromJSON = webKeyRSAConfig_RSAHasherFromJSON;
exports.webKeyRSAConfig_RSAHasherToJSON = webKeyRSAConfig_RSAHasherToJSON;
exports.webKeyECDSAConfig_ECDSACurveFromJSON = webKeyECDSAConfig_ECDSACurveFromJSON;
exports.webKeyECDSAConfig_ECDSACurveToJSON = webKeyECDSAConfig_ECDSACurveToJSON;
/* eslint-disable */
const wire_1 = require("@bufbuild/protobuf/wire");
exports.protobufPackage = "zitadel.resources.webkey.v3alpha";
var WebKeyRSAConfig_RSABits;
...
})(WebKeyRSAConfig_RSABits || (exports.WebKeyRSAConfig_RSABits = WebKeyRSAConfig_RSABits = {}));
function webKeyRSAConfig_RSABitsFromJSON(object) {
    switch (object) {
        case 0:
...
function webKeyRSAConfig_RSABitsToJSON(object) {
    switch (object) {
...
})(WebKeyRSAConfig_RSAHasher || (exports.WebKeyRSAConfig_RSAHasher = WebKeyRSAConfig_RSAHasher = {}));
function webKeyRSAConfig_RSAHasherFromJSON(object) {
    switch (object) {
        case 0:
...
function webKeyRSAConfig_RSAHasherToJSON(object) {
    switch (object) {
...
var WebKeyECDSAConfig_ECDSACurve;
...
})(WebKeyECDSAConfig_ECDSACurve || (exports.WebKeyECDSAConfig_ECDSACurve = WebKeyECDSAConfig_ECDSACurve = {}));
function webKeyECDSAConfig_ECDSACurveFromJSON(object) {
    switch (object) {
        case 0:
...
function webKeyECDSAConfig_ECDSACurveToJSON(object) {
    switch (object) {
...
exports.WebKeyRSAConfig = {
    ...
    create(base) {
        return exports.WebKeyRSAConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseWebKeyRSAConfig();
...
exports.WebKeyECDSAConfig = {
    ...
    create(base) {
        return exports.WebKeyECDSAConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseWebKeyECDSAConfig();
...
exports.WebKeyED25519Config = {
    ...
    create(base) {
        return exports.WebKeyED25519Config.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseWebKeyED25519Config();
        return message;
