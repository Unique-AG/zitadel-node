...
exports.UserAgent_HeaderEntry = exports.UserAgent_HeaderValues = exports.UserAgent = exports.ExpirationDateQuery = exports.UserAgentQuery = exports.CreatorQuery = exports.CreationDateQuery = exports.UserIDQuery = exports.IDsQuery = exports.SearchQuery = exports.OTPFactor = exports.TOTPFactor = exports.WebAuthNFactor = exports.IntentFactor = exports.PasswordFactor = exports.UserFactor = exports.Factors = exports.Session_MetadataEntry = exports.Session = exports.SessionFieldName = exports.protobufPackage = void 0;
...
exports.protobufPackage = "zitadel.session.v2";
...
exports.SearchQuery = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.creatorQuery !== undefined) {
            exports.CreatorQuery.encode(message.creatorQuery, writer.uint32(34).fork()).join();
        }
        if (message.userAgentQuery !== undefined) {
            exports.UserAgentQuery.encode(message.userAgentQuery, writer.uint32(42).fork()).join();
        }
        if (message.expirationDateQuery !== undefined) {
            exports.ExpirationDateQuery.encode(message.expirationDateQuery, writer.uint32(50).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.creatorQuery = exports.CreatorQuery.decode(reader, reader.uint32());
                    continue;
                }
                case 5: {
                    if (tag !== 42) {
                    ...
                    message.userAgentQuery = exports.UserAgentQuery.decode(reader, reader.uint32());
                    continue;
                }
                case 6: {
                    if (tag !== 50) {
                    ...
                    message.expirationDateQuery = exports.ExpirationDateQuery.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            creationDateQuery: isSet(object.creationDateQuery)
                ...
                : undefined,
            creatorQuery: isSet(object.creatorQuery) ? exports.CreatorQuery.fromJSON(object.creatorQuery) : undefined,
            userAgentQuery: isSet(object.userAgentQuery) ? exports.UserAgentQuery.fromJSON(object.userAgentQuery) : undefined,
            expirationDateQuery: isSet(object.expirationDateQuery)
                ? exports.ExpirationDateQuery.fromJSON(object.expirationDateQuery)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.creatorQuery !== undefined) {
            obj.creatorQuery = exports.CreatorQuery.toJSON(message.creatorQuery);
        }
        if (message.userAgentQuery !== undefined) {
            obj.userAgentQuery = exports.UserAgentQuery.toJSON(message.userAgentQuery);
        }
        if (message.expirationDateQuery !== undefined) {
            obj.expirationDateQuery = exports.ExpirationDateQuery.toJSON(message.expirationDateQuery);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.creatorQuery = (object.creatorQuery !== undefined && object.creatorQuery !== null)
            ? exports.CreatorQuery.fromPartial(object.creatorQuery)
            : undefined;
        message.userAgentQuery = (object.userAgentQuery !== undefined && object.userAgentQuery !== null)
            ? exports.UserAgentQuery.fromPartial(object.userAgentQuery)
            : undefined;
        message.expirationDateQuery = (object.expirationDateQuery !== undefined && object.expirationDateQuery !== null)
            ? exports.ExpirationDateQuery.fromPartial(object.expirationDateQuery)
            : undefined;
        return message;
    },
};
...
exports.CreatorQuery = {
    ...
    create(base) {
        return exports.CreatorQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCreatorQuery();
...
exports.UserAgentQuery = {
    ...
    create(base) {
        return exports.UserAgentQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUserAgentQuery();
...
function createBaseExpirationDateQuery() {
    return { expirationDate: undefined, method: 0 };
}
exports.ExpirationDateQuery = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.expirationDate !== undefined) {
    ...
    decode(input, length) {
        const reader = input instanceof wire_1.BinaryReader ? input : new wire_1.BinaryReader(input);
        const end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseExpirationDateQuery();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create(base) {
        return exports.ExpirationDateQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseExpirationDateQuery();
        message.expirationDate = object.expirationDate ?? undefined;
