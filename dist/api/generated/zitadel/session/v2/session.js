...
export const SearchQuery = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.expirationDateQuery !== undefined) {
            ExpirationDateQuery.encode(message.expirationDateQuery, writer.uint32(50).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6: {
                    ...
                    message.expirationDateQuery = ExpirationDateQuery.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            expirationDateQuery: isSet(object.expirationDateQuery)
                ? ExpirationDateQuery.fromJSON(object.expirationDateQuery)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.expirationDateQuery !== undefined) {
            obj.expirationDateQuery = ExpirationDateQuery.toJSON(message.expirationDateQuery);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.expirationDateQuery = (object.expirationDateQuery !== undefined && object.expirationDateQuery !== null)
            ? ExpirationDateQuery.fromPartial(object.expirationDateQuery)
            : undefined;
        return message;
    },
};
...
export const ExpirationDateQuery = {
    encode(message, writer = new BinaryWriter()) {
        if (message.expirationDate !== undefined) {
    ...
    create(base) {
        return ExpirationDateQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseExpirationDateQuery();
        message.expirationDate = object.expirationDate ?? undefined;
