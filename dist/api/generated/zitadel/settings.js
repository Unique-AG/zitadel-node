...
})(SMTPConfigState || (exports.SMTPConfigState = SMTPConfigState = {}));
...
})(EmailProviderState || (exports.EmailProviderState = EmailProviderState = {}));
...
exports.EmailProvider = {
    ...
    create(base) {
        return exports.EmailProvider.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEmailProvider();
        message.details = (object.details !== undefined && object.details !== null)
...
exports.EmailProviderSMTP = {
    ...
    create(base) {
        return exports.EmailProviderSMTP.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEmailProviderSMTP();
        message.senderAddress = object.senderAddress ?? "";
...
exports.EmailProviderHTTP = {
    ...
    create(base) {
        return exports.EmailProviderHTTP.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEmailProviderHTTP();
...
exports.HTTPConfig = {
    ...
    create(base) {
        return exports.HTTPConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseHTTPConfig();
        message.endpoint = object.endpoint ?? "";
