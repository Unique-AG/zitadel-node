...
exports.IdentityProvider = exports.LoginSettings = exports.IdentityProviderType = exports.PasskeysType = exports.MultiFactorType = exports.SecondFactorType = exports.protobufPackage = void 0;
...
const idp_js_1 = require("../../idp/v2/idp.js");
...
function createBaseIdentityProvider() {
    return { id: "", name: "", type: 0, options: undefined };
}
exports.IdentityProvider = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.options !== undefined) {
            idp_js_1.Options.encode(message.options, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.options = idp_js_1.Options.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            options: isSet(object.options) ? idp_js_1.Options.fromJSON(object.options) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.options !== undefined) {
            obj.options = idp_js_1.Options.toJSON(message.options);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.options = (object.options !== undefined && object.options !== null)
            ? idp_js_1.Options.fromPartial(object.options)
            : undefined;
        return message;
    },
};
