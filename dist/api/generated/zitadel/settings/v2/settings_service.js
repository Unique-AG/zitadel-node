...
exports.GetActiveIdentityProvidersRequest = {
    ...
    fromJSON(object) {
        return {
            ctx: isSet(object.ctx) ? object_js_1.RequestContext.fromJSON(object.ctx) : undefined,
...
exports.GetHostedLoginTranslationRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.GetHostedLoginTranslationRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetHostedLoginTranslationRequest();
...
exports.GetHostedLoginTranslationResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.etag !== "") {
            writer.uint32(10).string(message.etag);
        }
        if (message.translations !== undefined) {
            struct_js_1.Struct.encode(struct_js_1.Struct.wrap(message.translations), writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    message.translations = struct_js_1.Struct.unwrap(struct_js_1.Struct.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    create(base) {
        return exports.GetHostedLoginTranslationResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetHostedLoginTranslationResponse();
...
exports.SetHostedLoginTranslationRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.instance !== undefined) {
        ...
        if (message.translations !== undefined) {
            struct_js_1.Struct.encode(struct_js_1.Struct.wrap(message.translations), writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.SetHostedLoginTranslationRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSetHostedLoginTranslationRequest();
        message.instance = object.instance ?? undefined;
...
exports.SetHostedLoginTranslationResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.etag !== "") {
            writer.uint32(10).string(message.etag);
        }
    ...
    create(base) {
        return exports.SetHostedLoginTranslationResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSetHostedLoginTranslationResponse();
        message.etag = object.etag ?? "";
...
exports.SettingsServiceDefinition = {
    ...
    methods: {
        ...
        getHostedLoginTranslation: {
            ...
            requestType: exports.GetHostedLoginTranslationRequest,
            requestStream: false,
            responseType: exports.GetHostedLoginTranslationResponse,
            responseStream: false,
            options: {
                _unknownFields: {
                    8338: [
        ...
        setHostedLoginTranslation: {
            ...
            requestType: exports.SetHostedLoginTranslationRequest,
            requestStream: false,
            responseType: exports.SetHostedLoginTranslationResponse,
            responseStream: false,
            options: {
                _unknownFields: {
                    8338: [
