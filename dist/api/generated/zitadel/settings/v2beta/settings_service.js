...
import { OrganizationSettings, organizationSettingsFieldNameFromJSON, organizationSettingsFieldNameToJSON, OrganizationSettingsSearchFilter, } from "./organization_settings.js";
...
export const SetOrganizationSettingsRequest = {
    ...
    create(base) {
        return SetOrganizationSettingsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSetOrganizationSettingsRequest();
...
export const SetOrganizationSettingsResponse = {
    encode(message, writer = new BinaryWriter()) {
    ...
    create(base) {
        return SetOrganizationSettingsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSetOrganizationSettingsResponse();
...
export const DeleteOrganizationSettingsRequest = {
    encode(message, writer = new BinaryWriter()) {
        if (message.organizationId !== "") {
            writer.uint32(10).string(message.organizationId);
        }
    ...
    create(base) {
        return DeleteOrganizationSettingsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteOrganizationSettingsRequest();
        message.organizationId = object.organizationId ?? "";
...
export const DeleteOrganizationSettingsResponse = {
    encode(message, writer = new BinaryWriter()) {
    ...
    create(base) {
        return DeleteOrganizationSettingsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseDeleteOrganizationSettingsResponse();
...
export const ListOrganizationSettingsRequest = {
    encode(message, writer = new BinaryWriter()) {
        ...
        for (const v of message.filters) {
            OrganizationSettingsSearchFilter.encode(v, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.filters.push(OrganizationSettingsSearchFilter.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            sortingColumn: isSet(object.sortingColumn)
                ? organizationSettingsFieldNameFromJSON(object.sortingColumn)
                : undefined,
            filters: globalThis.Array.isArray(object?.filters)
                ? object.filters.map((e) => OrganizationSettingsSearchFilter.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.sortingColumn !== undefined) {
            obj.sortingColumn = organizationSettingsFieldNameToJSON(message.sortingColumn);
        }
        if (message.filters?.length) {
            obj.filters = message.filters.map((e) => OrganizationSettingsSearchFilter.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return ListOrganizationSettingsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseListOrganizationSettingsRequest();
        ...
        message.filters = object.filters?.map((e) => OrganizationSettingsSearchFilter.fromPartial(e)) || [];
        return message;
    },
};
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    message.organizationSettings.push(OrganizationSettings.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            organizationSettings: globalThis.Array.isArray(object?.organizationSettings)
                ? object.organizationSettings.map((e) => OrganizationSettings.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.organizationSettings?.length) {
            obj.organizationSettings = message.organizationSettings.map((e) => OrganizationSettings.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return ListOrganizationSettingsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseListOrganizationSettingsResponse();
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ...
            : undefined;
        message.organizationSettings = object.organizationSettings?.map((e) => OrganizationSettings.fromPartial(e)) || [];
        return message;
    },
};
