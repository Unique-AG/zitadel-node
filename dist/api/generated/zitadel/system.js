...
exports.ListIAMMembersRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            sortingColumn: isSet(object.sortingColumn) ? (0, member_js_1.memberFieldColumnNameFromJSON)(object.sortingColumn) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.sortingColumn !== 0) {
            obj.sortingColumn = (0, member_js_1.memberFieldColumnNameToJSON)(message.sortingColumn);
        }
        return obj;
    },
    create(base) {
