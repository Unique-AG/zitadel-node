...
export const LoginCustomText = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.linkingUserPromptText !== undefined) {
            LinkingUserPromptScreenText.encode(message.linkingUserPromptText, writer.uint32(298).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const PasswordChangeScreenText = {
    ...
    fromPartial(object) {
        ...
        message.cancelButtonText = object.cancelButtonText ?? "";
        message.nextButtonText = object.nextButtonText ?? "";
        message.expiredDescription = object.expiredDescription ?? "";
        return message;
    },
};
...
export const LinkingUserPromptScreenText = {
    encode(message, writer = new BinaryWriter()) {
        if (message.title !== "") {
            writer.uint32(10).string(message.title);
        }
    ...
    create(base) {
        return LinkingUserPromptScreenText.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseLinkingUserPromptScreenText();
        message.title = object.title ?? "";
        ...
        message.otherButtonText = object.otherButtonText ?? "";
        return message;
    },
};
