...
exports.UserGrantUserTypeQuery = exports.UserGrantDisplayNameQuery = exports.UserGrantProjectNameQuery = exports.UserGrantOrgDomainQuery = exports.UserGrantOrgNameQuery = exports.UserGrantEmailQuery = exports.UserGrantLastNameQuery = exports.UserGrantFirstNameQuery = exports.UserGrantUserNameQuery = exports.UserGrantProjectGrantIDQuery = exports.UserGrantRoleKeyQuery = exports.UserGrantWithGrantedQuery = exports.UserGrantInUserIDsQuery = exports.UserGrantUserIDQuery = void 0;
...
exports.UserGrantQuery = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.inUserIdsQuery !== undefined) {
            exports.UserGrantInUserIDsQuery.encode(message.inUserIdsQuery, writer.uint32(122).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 15: {
                    ...
                    message.inUserIdsQuery = exports.UserGrantInUserIDsQuery.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            inUserIdsQuery: isSet(object.inUserIdsQuery)
                ? exports.UserGrantInUserIDsQuery.fromJSON(object.inUserIdsQuery)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.inUserIdsQuery !== undefined) {
            obj.inUserIdsQuery = exports.UserGrantInUserIDsQuery.toJSON(message.inUserIdsQuery);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.userTypeQuery = (object.userTypeQuery !== undefined && object.userTypeQuery !== null)
            ...
            : undefined;
        message.inUserIdsQuery = (object.inUserIdsQuery !== undefined && object.inUserIdsQuery !== null)
            ? exports.UserGrantInUserIDsQuery.fromPartial(object.inUserIdsQuery)
            : undefined;
        return message;
    },
};
...
exports.UserGrantInUserIDsQuery = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.UserGrantInUserIDsQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUserGrantInUserIDsQuery();
