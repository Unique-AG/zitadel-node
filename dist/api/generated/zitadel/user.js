...
export const UserGrantQuery = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.inUserIdsQuery !== undefined) {
            UserGrantInUserIDsQuery.encode(message.inUserIdsQuery, writer.uint32(122).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 15: {
                    ...
                    message.inUserIdsQuery = UserGrantInUserIDsQuery.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            inUserIdsQuery: isSet(object.inUserIdsQuery)
                ? UserGrantInUserIDsQuery.fromJSON(object.inUserIdsQuery)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.inUserIdsQuery !== undefined) {
            obj.inUserIdsQuery = UserGrantInUserIDsQuery.toJSON(message.inUserIdsQuery);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.userTypeQuery = (object.userTypeQuery !== undefined && object.userTypeQuery !== null)
            ...
            : undefined;
        message.inUserIdsQuery = (object.inUserIdsQuery !== undefined && object.inUserIdsQuery !== null)
            ? UserGrantInUserIDsQuery.fromPartial(object.inUserIdsQuery)
            : undefined;
        return message;
    },
};
...
function createBaseUserGrantInUserIDsQuery() {
    return { inUserIds: [] };
}
export const UserGrantInUserIDsQuery = {
    encode(message, writer = new BinaryWriter()) {
        for (const v of message.inUserIds) {
            writer.uint32(10).string(v);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseUserGrantInUserIDsQuery();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.inUserIds.push(reader.string());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            inUserIds: globalThis.Array.isArray(object?.inUserIds)
                ? object.inUserIds.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.inUserIds?.length) {
            obj.inUserIds = message.inUserIds;
        }
        return obj;
    },
    create(base) {
        return UserGrantInUserIDsQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUserGrantInUserIDsQuery();
        message.inUserIds = object.inUserIds?.map((e) => e) || [];
        return message;
    },
};
