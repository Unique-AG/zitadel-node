...
exports.FormData_FieldsEntry = exports.FormData = exports.IDPLink = exports.IDPSAMLAccessInformation = exports.IDPLDAPAccessInformation = exports.IDPOAuthAccessInformation = exports.IDPInformation = exports.IDPIntent = exports.RedirectURLs = exports.LDAPCredentials = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.FormData = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        Object.entries(message.fields).forEach(([key, value]) => {
            exports.FormData_FieldsEntry.encode({ key: key, value }, writer.uint32(18).fork()).join();
        });
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    const entry2 = exports.FormData_FieldsEntry.decode(reader, reader.uint32());
    ...
    create(base) {
        return exports.FormData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseFormData();
...
function createBaseFormData_FieldsEntry() {
    return { key: "", value: "" };
}
exports.FormData_FieldsEntry = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.key !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof wire_1.BinaryReader ? input : new wire_1.BinaryReader(input);
        const end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseFormData_FieldsEntry();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create(base) {
        return exports.FormData_FieldsEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseFormData_FieldsEntry();
