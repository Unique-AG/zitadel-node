...
export const FormData = {
    encode(message, writer = new BinaryWriter()) {
        ...
        Object.entries(message.fields).forEach(([key, value]) => {
            FormData_FieldsEntry.encode({ key: key, value }, writer.uint32(18).fork()).join();
        });
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    const entry2 = FormData_FieldsEntry.decode(reader, reader.uint32());
    ...
    create(base) {
        return FormData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseFormData();
...
export const FormData_FieldsEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
    ...
    create(base) {
        return FormData_FieldsEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseFormData_FieldsEntry();
