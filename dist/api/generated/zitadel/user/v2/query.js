...
exports.OrganizationIdQuery = exports.InUserEmailsQuery = exports.TypeQuery = exports.StateQuery = exports.LoginNameQuery = exports.PhoneQuery = exports.EmailQuery = exports.DisplayNameQuery = exports.NickNameQuery = exports.LastNameQuery = exports.FirstNameQuery = exports.UserNameQuery = exports.InUserIDQuery = exports.NotQuery = exports.AndQuery = exports.OrQuery = exports.SearchQuery = exports.UserFieldName = exports.Type = exports.protobufPackage = void 0;
...
function createBaseSearchQuery() {
    return {
        ...
        metadataKeyFilter: undefined,
        metadataValueFilter: undefined,
    };
}
exports.SearchQuery = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.phoneQuery !== undefined) {
            exports.PhoneQuery.encode(message.phoneQuery, writer.uint32(130).fork()).join();
        }
        if (message.metadataKeyFilter !== undefined) {
            metadata_js_1.MetadataKeyFilter.encode(message.metadataKeyFilter, writer.uint32(138).fork()).join();
        }
        if (message.metadataValueFilter !== undefined) {
            metadata_js_1.MetadataValueFilter.encode(message.metadataValueFilter, writer.uint32(146).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 16: {
                    ...
                    message.phoneQuery = exports.PhoneQuery.decode(reader, reader.uint32());
                    continue;
                }
                case 17: {
                    if (tag !== 138) {
                    ...
                    message.metadataKeyFilter = metadata_js_1.MetadataKeyFilter.decode(reader, reader.uint32());
                    continue;
                }
                case 18: {
                    if (tag !== 146) {
                    ...
                    message.metadataValueFilter = metadata_js_1.MetadataValueFilter.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            organizationIdQuery: isSet(object.organizationIdQuery)
                ...
                : undefined,
            phoneQuery: isSet(object.phoneQuery) ? exports.PhoneQuery.fromJSON(object.phoneQuery) : undefined,
            metadataKeyFilter: isSet(object.metadataKeyFilter)
                ? metadata_js_1.MetadataKeyFilter.fromJSON(object.metadataKeyFilter)
                : undefined,
            metadataValueFilter: isSet(object.metadataValueFilter)
                ? metadata_js_1.MetadataValueFilter.fromJSON(object.metadataValueFilter)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.phoneQuery !== undefined) {
            obj.phoneQuery = exports.PhoneQuery.toJSON(message.phoneQuery);
        }
        if (message.metadataKeyFilter !== undefined) {
            obj.metadataKeyFilter = metadata_js_1.MetadataKeyFilter.toJSON(message.metadataKeyFilter);
        }
        if (message.metadataValueFilter !== undefined) {
            obj.metadataValueFilter = metadata_js_1.MetadataValueFilter.toJSON(message.metadataValueFilter);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.phoneQuery = (object.phoneQuery !== undefined && object.phoneQuery !== null)
            ? exports.PhoneQuery.fromPartial(object.phoneQuery)
            : undefined;
        message.metadataKeyFilter = (object.metadataKeyFilter !== undefined && object.metadataKeyFilter !== null)
            ? metadata_js_1.MetadataKeyFilter.fromPartial(object.metadataKeyFilter)
            : undefined;
        message.metadataValueFilter = (object.metadataValueFilter !== undefined && object.metadataValueFilter !== null)
            ? metadata_js_1.MetadataValueFilter.fromPartial(object.metadataValueFilter)
            : undefined;
        return message;
    },
};
...
exports.OrQuery = {
    ...
    fromJSON(object) {
        return {
            queries: globalThis.Array.isArray(object?.queries) ? object.queries.map((e) => exports.SearchQuery.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.PhoneQuery = {
    ...
    create(base) {
        return exports.PhoneQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePhoneQuery();
...
exports.InUserEmailsQuery = {
    ...
    create(base) {
        return exports.InUserEmailsQuery.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseInUserEmailsQuery();
