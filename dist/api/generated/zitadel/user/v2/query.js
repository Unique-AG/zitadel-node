...
export const SearchQuery = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.metadataKeyFilter !== undefined) {
            MetadataKeyFilter.encode(message.metadataKeyFilter, writer.uint32(138).fork()).join();
        }
        if (message.metadataValueFilter !== undefined) {
            MetadataValueFilter.encode(message.metadataValueFilter, writer.uint32(146).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 17: {
                    ...
                    message.metadataKeyFilter = MetadataKeyFilter.decode(reader, reader.uint32());
                    continue;
                }
                case 18: {
                    if (tag !== 146) {
                    ...
                    message.metadataValueFilter = MetadataValueFilter.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            metadataKeyFilter: isSet(object.metadataKeyFilter)
                ? MetadataKeyFilter.fromJSON(object.metadataKeyFilter)
                : undefined,
            metadataValueFilter: isSet(object.metadataValueFilter)
                ? MetadataValueFilter.fromJSON(object.metadataValueFilter)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.metadataKeyFilter !== undefined) {
            obj.metadataKeyFilter = MetadataKeyFilter.toJSON(message.metadataKeyFilter);
        }
        if (message.metadataValueFilter !== undefined) {
            obj.metadataValueFilter = MetadataValueFilter.toJSON(message.metadataValueFilter);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.metadataKeyFilter = (object.metadataKeyFilter !== undefined && object.metadataKeyFilter !== null)
            ? MetadataKeyFilter.fromPartial(object.metadataKeyFilter)
            : undefined;
        message.metadataValueFilter = (object.metadataValueFilter !== undefined && object.metadataValueFilter !== null)
            ? MetadataValueFilter.fromPartial(object.metadataValueFilter)
            : undefined;
        return message;
    },
};
