...
exports.ReturnInviteCode = exports.SendInviteCode = exports.AuthFactorU2F = exports.AuthFactorOTPEmail = exports.AuthFactorOTPSMS = exports.AuthFactorOTP = exports.AuthFactor = exports.Passkey = exports.MachineUser = exports.User = exports.HumanUser = exports.SetMetadataEntry = exports.HumanProfile = exports.SetHumanProfile = exports.AuthFactorState = exports.UserState = exports.AccessTokenType = exports.Gender = exports.protobufPackage = void 0;
...
exports.HumanUser = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.mfaInitSkipped !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.mfaInitSkipped), writer.uint32(90).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11: {
                    ...
                    message.mfaInitSkipped = fromTimestamp(timestamp_js_1.Timestamp.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
...
exports.Passkey = {
    ...
    create(base) {
        return exports.Passkey.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePasskey();
...
exports.SendInviteCode = {
    ...
    create(base) {
        return exports.SendInviteCode.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSendInviteCode();
...
exports.ReturnInviteCode = {
    ...
    create(base) {
        return exports.ReturnInviteCode.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseReturnInviteCode();
        return message;
