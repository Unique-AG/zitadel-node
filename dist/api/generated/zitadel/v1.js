...
import { genderFromJSON, genderToJSON, userStateFromJSON, userStateToJSON } from "./user.js";
...
export const DataOrg = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.iamPolicy !== undefined) {
            AddCustomOrgIAMPolicyRequest.encode(message.iamPolicy, writer.uint32(34).fork()).join();
        }
        ...
        for (const v of message.loginTexts) {
            SetCustomLoginTextsRequest.encode(v, writer.uint32(194).fork()).join();
        }
        ...
        for (const v of message.secondFactors) {
            AddSecondFactorToLoginPolicyRequest.encode(v, writer.uint32(266).fork()).join();
        }
        for (const v of message.multiFactors) {
            AddMultiFactorToLoginPolicyRequest.encode(v, writer.uint32(274).fork()).join();
        }
        for (const v of message.idps) {
            AddIDPToLoginPolicyRequest.encode(v, writer.uint32(282).fork()).join();
        }
        for (const v of message.userLinks) {
            IDPUserLink.encode(v, writer.uint32(290).fork()).join();
        }
        for (const v of message.domains) {
            Domain.encode(v, writer.uint32(298).fork()).join();
        }
        for (const v of message.appKeys) {
            DataAppKey.encode(v, writer.uint32(306).fork()).join();
        }
        for (const v of message.machineKeys) {
            DataMachineKey.encode(v, writer.uint32(314).fork()).join();
        }
        for (const v of message.inviteUserMessages) {
            SetCustomInviteUserMessageTextRequest.encode(v, writer.uint32(322).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            loginTexts: globalThis.Array.isArray(object?.loginTexts)
                ? object.loginTexts.map((e) => SetCustomLoginTextsRequest.fromJSON(e))
                : [],
            ...
            secondFactors: globalThis.Array.isArray(object?.secondFactors)
                ? object.secondFactors.map((e) => AddSecondFactorToLoginPolicyRequest.fromJSON(e))
                : [],
            multiFactors: globalThis.Array.isArray(object?.multiFactors)
                ? object.multiFactors.map((e) => AddMultiFactorToLoginPolicyRequest.fromJSON(e))
                : [],
            idps: globalThis.Array.isArray(object?.idps)
                ? object.idps.map((e) => AddIDPToLoginPolicyRequest.fromJSON(e))
                : [],
            ...
            domains: globalThis.Array.isArray(object?.domains)
                ? object.domains.map((e) => Domain.fromJSON(e))
                : [],
...
export const DataOIDCIDP = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.idp !== undefined) {
            AddOrgOIDCIDPRequest.encode(message.idp, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const DataJWTIDP = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.idp !== undefined) {
            AddOrgJWTIDPRequest.encode(message.idp, writer.uint32(258).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const ExportHumanUser = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.profile !== undefined) {
            ExportHumanUser_Profile.encode(message.profile, writer.uint32(18).fork()).join();
        }
        if (message.email !== undefined) {
            ExportHumanUser_Email.encode(message.email, writer.uint32(26).fork()).join();
        }
        if (message.phone !== undefined) {
            ExportHumanUser_Phone.encode(message.phone, writer.uint32(34).fork()).join();
        }
        if (message.password !== "") {
            writer.uint32(42).string(message.password);
        }
        if (message.hashedPassword !== undefined) {
            ExportHumanUser_HashedPassword.encode(message.hashedPassword, writer.uint32(50).fork()).join();
        }
...
export const DataProject = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.project !== undefined) {
            AddProjectRequest.encode(message.project, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const DataAPIApplication = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.app !== undefined) {
            AddAPIAppRequest.encode(message.app, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const DataOIDCApplication = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.app !== undefined) {
            AddOIDCAppRequest.encode(message.app, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const DataHumanUser = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.user !== undefined) {
            ImportHumanUserRequest.encode(message.user, writer.uint32(18).fork()).join();
        }
        if (message.state !== 0) {
...
export const DataMachineUser = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.user !== undefined) {
            AddMachineUserRequest.encode(message.user, writer.uint32(18).fork()).join();
        }
        if (message.state !== 0) {
            writer.uint32(24).int32(message.state);
        }
...
export const DataAction = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.action !== undefined) {
            CreateActionRequest.encode(message.action, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const DataProjectGrant = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.projectGrant !== undefined) {
            AddProjectGrantRequest.encode(message.projectGrant, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
