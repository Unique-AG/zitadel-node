...
exports.DataOrg = {
    ...
    fromPartial(object) {
        ...
        message.projectRoles = object.projectRoles?.map((e) => management_js_1.AddProjectRoleRequest.fromPartial(e)) || [];
        ...
        message.userGrants = object.userGrants?.map((e) => management_js_1.AddUserGrantRequest.fromPartial(e)) || [];
        message.orgMembers = object.orgMembers?.map((e) => management_js_1.AddOrgMemberRequest.fromPartial(e)) || [];
        message.projectMembers = object.projectMembers?.map((e) => management_js_1.AddProjectMemberRequest.fromPartial(e)) || [];
        message.projectGrantMembers = object.projectGrantMembers?.map((e) => management_js_1.AddProjectGrantMemberRequest.fromPartial(e)) ||
            [];
        message.userMetadata = object.userMetadata?.map((e) => management_js_1.SetUserMetadataRequest.fromPartial(e)) || [];
        message.loginTexts = object.loginTexts?.map((e) => management_js_1.SetCustomLoginTextsRequest.fromPartial(e)) || [];
        message.initMessages = object.initMessages?.map((e) => management_js_1.SetCustomInitMessageTextRequest.fromPartial(e)) || [];
        message.passwordResetMessages =
            object.passwordResetMessages?.map((e) => management_js_1.SetCustomPasswordResetMessageTextRequest.fromPartial(e)) || [];
        message.verifyEmailMessages =
            object.verifyEmailMessages?.map((e) => management_js_1.SetCustomVerifyEmailMessageTextRequest.fromPartial(e)) || [];
        message.verifyPhoneMessages =
            object.verifyPhoneMessages?.map((e) => management_js_1.SetCustomVerifyPhoneMessageTextRequest.fromPartial(e)) || [];
        message.domainClaimedMessages =
            object.domainClaimedMessages?.map((e) => management_js_1.SetCustomDomainClaimedMessageTextRequest.fromPartial(e)) || [];
        message.passwordlessRegistrationMessages =
            object.passwordlessRegistrationMessages?.map((e) => management_js_1.SetCustomPasswordlessRegistrationMessageTextRequest.fromPartial(e)) || [];
        ...
        message.secondFactors = object.secondFactors?.map((e) => management_js_1.AddSecondFactorToLoginPolicyRequest.fromPartial(e)) || [];
        message.multiFactors = object.multiFactors?.map((e) => management_js_1.AddMultiFactorToLoginPolicyRequest.fromPartial(e)) || [];
        message.idps = object.idps?.map((e) => management_js_1.AddIDPToLoginPolicyRequest.fromPartial(e)) || [];
        message.userLinks = object.userLinks?.map((e) => idp_js_1.IDPUserLink.fromPartial(e)) || [];
        ...
        message.inviteUserMessages =
            object.inviteUserMessages?.map((e) => management_js_1.SetCustomInviteUserMessageTextRequest.fromPartial(e)) || [];
        return message;
    },
};
...
function createBaseDataHumanUser() {
    return { userId: "", user: undefined, state: 0 };
}
exports.DataHumanUser = {
    ...
    fromJSON(object) {
        return {
            ...
            state: isSet(object.state) ? (0, user_js_1.userStateFromJSON)(object.state) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
