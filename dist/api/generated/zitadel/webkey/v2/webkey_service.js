...
exports.WebKeyServiceDefinition = {
    name: "WebKeyService",
    fullName: "zitadel.webkey.v2.WebKeyService",
    methods: {
        /**
         * Create Web Key
         *
        ...
        deleteWebKey: {
            ...
            options: {
                _unknownFields: {
                    ...
                    578365826: [
                        Buffer.from([19, 42, 17, 47, 118, 50, 47, 119, 101, 98, 95, 107, 101, 121, 115, 47, 123, 105, 100, 125]),
                    ],
                },
            },
        },
        ...
        listWebKeys: {
            ...
            options: {
                _unknownFields: {
                    ...
                    578365826: [Buffer.from([14, 18, 12, 47, 118, 50, 47, 119, 101, 98, 95, 107, 101, 121, 115])],
                },
            },
        },
    },
